    ...
    while(x->parent!=NULL ){
        ...
        if(p==g->left){
            ...
            if(gg!=NULL){
                ...
                if(gg->left==g)gg->left = rightRotate(gg->left);
                else gg->right = rightRotate(gg->right);
                x= gg;
            }
            else x = rightRotate(g);
            continue;
        }
        else{
            if(x==p->right){
            ...
            if(gg!=NULL){
                if(gg->right==g)gg->right = leftRotate(gg->right);
                else gg->left = leftRotate(gg->left);
                x = gg; 
            }
            else x = leftRotate(g);
            continue;
